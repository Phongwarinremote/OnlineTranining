...
namespace OnlineTranining.API.Data.MigrationHistory
{
    /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Score = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DateRecord = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TakeTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
